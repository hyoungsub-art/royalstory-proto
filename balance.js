...
window.BALANCE = {
  ...
  ECON: { regen: 2.8, start: 6, cap: [0, 10, 20, 30], gasBonus: 0.5,
          ...
          starBy: "blood",               // ★ 적립: "blood" = 적 유닛 처치 게이지(기본) / "regen" = 누적 회복량(cap×starPer 단위, 실험용)
          bloodPer: 30,                  // 블러드 이만큼마다 블러드 스타 1개 (풋맨 ≈ 9 → 약 3.3기)
          bloodDiv: 100,                 // 처치 유닛 maxHp ÷ 이 값 = 블러드 (풋맨 9, 나이트 23, 드래곤 24, 영웅 26~42)
          starPer: 1.0,                  // regen 모드 전용
          tierStars: [0, 0, 1, 2],       // 승급: 킵 ★1 / 캐슬 ★2
          transformStar: 1,              // 건물 변형 비용 일괄 ★1 (2026-09-08 확정) — 승급(tierStars)과 별개
  ...
  HERO_COST: 1,     // 영웅 공통 코스트 — 단위: 블러드 스타 (최소 1, 전원 동일)
