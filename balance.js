...
window.BALANCE = {
  ...
  RUIN_LINE: { off: 4, h: 2 },   // 무너진 성벽 흔적 (2026-09-13): 본진 앞 off칸 간격, h칸 두께 가로 성벽선 — 거점은 이 위에서만
  HALL_REACH: [0, 6, 10, 14],  // 건설 지역 (2026-09-13 확정): 아군 쪽 맵 끝에서 세로 행수 × 맵 가로 전체 — 타운홀 6 / 킵 10 / 캐슬 14 (가정). 거점·광산도 이 안에서만
  BUILD_RING: [0, 2, 4, 6],    // 거점 주변 보조 띠 (본진 지역과 합집합)   // 건설 띠 폭[티어] (2026-09-12 확정): 본진·거점 풋프린트 주변 — 타운홀 2 / 킵 4 / 캐슬 6 (승급마다 +2, 강등 없음). 거점 자체는 어디든 건설 가능
