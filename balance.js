...
window.BALANCE = {
  ...
  ECON: { regen: 2.8, start: 6, cap: [0, 10, 20, 30], gasBonus: 0.5,
          tierCost: [0, 0, 12, 20],      // 킵 12 / 캐슬 20 (2026-09-04 상향 — 스타 자동 사용으로 상한 초과 지불 가능)
          upCost: [0, 0, 10, 12],        // 레벨2 10 / 레벨3 12 — 규칙: 레벨업 비용 < 변형 비용(14) (2026-09-07)
          transformCost: 14 },           // 변형 14 (상향)
