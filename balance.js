...
window.BALANCE = {
  ...
  /* 2026-09-07 경제 개편: 승급·변형 = 엘릭서 스타(★), 레벨업 = 엘릭서 (레벨당 고정) */
  ECON: { regen: 2.8, start: 6, cap: [0, 10, 20, 30], gasBonus: 0.5,
          starBy: "regen",               // ★ 적립 방식 (2026-09-12 확정): "regen" = 누적 회복량 기준(지출과 무관) / "cap" = 구 방식(상한 도달 시)
          starPer: 1.0,                  // regen 모드: 상한 × 이 배수만큼 회복될 때마다 ★1 (가정 — 너무 빠르면 1.5)
          tierStars: [0, 0, 1, 2],       // 승급: 킵 ★1 / 캐슬 ★2
          transformStar: 1,              // 건물 변형 비용 일괄 ★1 (2026-09-08 확정) — 승급(tierStars)과 별개
          upPerLevel: [0, 4, 8, 12] },   // 레벨업(레벨당 엘릭서): 1티어 건설 4 / 킵 건설 8 / 변형 획득 12
